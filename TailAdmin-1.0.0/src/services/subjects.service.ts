...
class SubjectsService {
  ...
  async getSubjects(): Promise<Subject[]> {
    try {
      ...
      console.log('📦 SubjectsService.getSubjects - Raw response:', res);
      ...
      console.log('✅ SubjectsService.getSubjects - Parsed subjects:', subjectsArray.length);
  ...
  async getSubjectById(id: number): Promise<Subject> {
    try {
      ...
      console.log('📦 SubjectsService.getSubjectById - Raw response:', res);
  ...
  async createSubject(request: CreateSubjectRequest): Promise<Subject> {
    try {
      ...
      console.log('📦 SubjectsService.createSubject - Raw response:', res);
  ...
  async updateSubject(id: number, request: UpdateSubjectRequest): Promise<Subject> {
    try {
      ...
      console.log('📦 SubjectsService.updateSubject - Raw response:', res);
