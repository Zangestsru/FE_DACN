...
export const PAYMENT_ENDPOINTS = {
  ...
  PAYOS: {
    CREATE_LINK: '/payments/payos/create-link',
    CREATE_FOOD_DRINK_LINK: '/payments/payos/food-drink/create-link',
    GET_ORDER: (orderCode: string | number) => `/payments/payos/order/${orderCode}`,
  },
} as const;
