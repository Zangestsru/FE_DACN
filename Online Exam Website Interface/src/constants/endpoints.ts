...
export const EXAM_ENDPOINTS = {
  ...
  MY_RESULTS: (userId: string | number) => `/Exams/results/${userId}`,
  ...
  PAYOS: {
    CREATE_LINK: (id: string | number) => `/Exams/${id}/purchase/payos`,
    GET_ORDER: (orderCode: string | number) => `/Exams/payos/order/${orderCode}`,
  },
  MY_PAYMENTS: '/Exams/payments/my',
} as const;
...
export const COURSE_ENDPOINTS = {
  ...
  PAYOS: {
    CREATE_LINK: (id: string | number) => `/Courses/${id}/purchase/payos`,
    GET_ORDER: (orderCode: string | number) => `/Courses/payos/order/${orderCode}`,
  },
} as const;
...
export const PAYMENT_ENDPOINTS = {
  ...
  PAYOS: {
    CREATE_LINK: '/payments/payos/create',
    CREATE_FOOD_DRINK_LINK: '/payments/payos/create',
    GET_ORDER: (orderCode: string | number) => `/payments/payos/status/${orderCode}`,
  },
} as const;
