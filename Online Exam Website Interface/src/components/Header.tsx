...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  // State MỚI cho desktop search expansion
  ...
  // Hàm MỚI để bật/tắt desktop search expansion
          ...
          <div className="header-top d-none d-lg-flex">
            ...
            <div className="header-logo">
              ...
              >
                ...
                <div className={`logo-text ${isDesktopSearchExpanded ? 'logo-hidden' : ''}`}>
                  <h1>THI CHỨNG CHỈ</h1>
            ...
            {isDesktopSearchExpanded && (
              <div className="desktop-search-expanded-inline">
                <input 
                  type="search" 
                  placeholder="Tìm kiếm..." 
                  autoFocus
                  className="desktop-search-input-inline"
                />
                <button 
                  className="desktop-search-close-inline"
            ...
            <div className="header-right">
              {/* Search (Desktop) - Chỉ hiển thị khi không expanded */}
              {!isDesktopSearchExpanded && (
