...
export const ExamDetail: React.FC<ExamDetailProps> = ({ onBackToList, onRegister, onStartExam }) => {
  ...
  const examSections = [
    { name: 'Lý thuyết cơ bản', questions: Math.floor((exam.questions || 0) * 0.3), time: '30 phút' },
    { name: 'Thực hành ứng dụng', questions: Math.floor((exam.questions || 0) * 0.4), time: '45 phút' },
    { name: 'Tình huống thực tế', questions: Math.floor((exam.questions || 0) * 0.3), time: '35 phút' }
  ];
