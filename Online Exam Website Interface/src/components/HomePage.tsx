...
interface HomePageProps {
  ...
  onTestExamStart?: () => void;
}

export const HomePage: React.FC<HomePageProps> = ({ onCertificationClick, onTestExamStart }) => {
  ...
  return (
    <div className="homepage">
      ...
      {/* Test Navigation Section */}
       <section className="test-nav-section py-3 bg-warning">
         <div className="container-fluid text-center px-3 px-md-4">
           <button 
             className="btn btn-dark"
             onClick={onTestExamStart}
           >
             TEST: Direct to Exam Start Page
           </button>
         </div>
       </section>
