    ...
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b shadow-sm">
      <div className="flex flex-col items-center justify-between flex-grow lg:flex-row lg:px-4">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-2 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-2">
          <button
            className="items-center justify-center w-8 h-8 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 lg:flex dark:text-gray-400 lg:h-9 lg:w-9 lg:border"
          ...
          <div className="hidden lg:block">
            <form>
              <div className="relative">
                ...
                <button className="absolute right-2 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded border border-gray-200 bg-gray-50 px-1.5 py-1 text-xs -tracking-[0.2px] text-gray-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400">
                  <span> ⌘ </span>
                  <span> K </span>
                </button>
              </div>
        ...
        <div
          ...
          } items-center justify-between w-full gap-3 px-3 py-2 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none`}
        >
