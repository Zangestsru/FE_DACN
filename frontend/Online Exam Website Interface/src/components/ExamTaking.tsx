...
export const ExamTaking: React.FC<ExamTakingProps> = ({ exam, onSubmitExam }) => {
  ...
  return (
    <div className="exam-taking-container d-flex exam-taking-root" style={{ minHeight: '100vh', height: 'auto', overflow: 'hidden' }}>
      {/* Sidebar */}
      <div className="exam-sidebar bg-light border-end exam-taking-sidebar d-none d-lg-block" style={{ width: '300px', height: '100vh', position: 'fixed', top: 0, left: 0, overflow: 'auto', zIndex: 1000 }}>
